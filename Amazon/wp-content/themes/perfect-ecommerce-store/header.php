				...
				<div class="row">
					<div class="col-lg-9 col-md-8 col-3">
						<div class="toggle-menu responsive-menu">
				            <button onclick="perfect_ecommerce_store_open()" role="tab" class="mobiletoggle"><i class="fas fa-bars"></i><span class="screen-reader-text"><?php esc_html_e('Open Menu','perfect-ecommerce-store'); ?></span></button>
				        </div>
						<div id="resp-menu" class="nav sidenav primary-menu">
			                <nav id="primary-site-navigation" class="nav-menu" role="navigation" aria-label="<?php esc_attr_e( 'Responsive Menu', 'perfect-ecommerce-store' ); ?>">
			                    <?php 
			                    wp_nav_menu( array( 
