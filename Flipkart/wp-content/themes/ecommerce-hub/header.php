  ...
  <header role="banner" class="header">
    ...
    <?php if (has_nav_menu('primary')){ ?>
      <div class="toggle-menu responsive-menu">
        <button role="tab"><i class="fas fa-bars"></i><?php esc_html_e('Menu','ecommerce-hub'); ?><span class="screen-reader-text"><?php esc_html_e('Menu','ecommerce-hub'); ?></span></button>
      </div>
    <?php }?>
            ...
            <div class="menubox col-lg-7 col-md-0 p-0">
              <div id="sidelong-menu" class="nav side-nav">
                <nav id="primary-site-navigation" class="nav-menu" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'ecommerce-hub' ); ?>">
                  ...
                  <a href="javascript:void(0)" class="closebtn responsive-menu"><?php esc_html_e('Close Menu','ecommerce-hub'); ?><i class="fas fa-times-circle"></i><span class="screen-reader-text"><?php esc_html_e('Close Menu','ecommerce-hub'); ?></span></a>
                </nav>
              </div>
            </div>
                  ...
                  <?php if ( get_theme_mod('ecommerce_hub_email_text','') != "" ) {?>
                    ...
                    <div class="col-lg-10 col-md-10 p-0">
                      ...
                      <?php if ( get_theme_mod('ecommerce_hub_email','') != "" ) {?>
                        <a href="mailto:<?php echo esc_attr( get_theme_mod('ecommerce_hub_email','') ); ?>"><p><?php echo esc_html( get_theme_mod('ecommerce_hub_email','') ); ?></p><span class="screen-reader-text"><?php esc_html_e('Email', 'ecommerce-hub') ?></span></a>
                      <?php }?>
                    </div>
                  <?php }?>
                </div>
                  ...
                  <?php if ( get_theme_mod('ecommerce_hub_call_text','') != "" ) {?>
                    ...
                    <div class="col-lg-10 col-md-10 p-0">
                      ...
                      <?php if ( get_theme_mod('ecommerce_hub_call_number','') != "" ) {?>
                        <a href="tel:<?php echo esc_attr( get_theme_mod('ecommerce_hub_call_number','') ); ?>"><p><?php echo esc_html( get_theme_mod('ecommerce_hub_call_number','' )); ?></p><span class="screen-reader-text"><?php esc_html_e('Phone Number', 'ecommerce-hub') ?></span></a>
                      <?php }?>
                    </div>
                  <?php }?>
                </div>
