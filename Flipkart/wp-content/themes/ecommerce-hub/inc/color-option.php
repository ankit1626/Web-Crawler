<?php
	...
	if($ecommerce_hub_product_border == true){
		$ecommerce_hub_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$ecommerce_hub_custom_css .='border: 1px solid '.esc_html($ecommerce_hub_first_theme_color).';';
		$ecommerce_hub_custom_css .='}';
	}
	...
	if($ecommerce_hub_product_top != false || $ecommerce_hub_product_bottom != false || $ecommerce_hub_product_left != false || $ecommerce_hub_product_right != false){
		$ecommerce_hub_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$ecommerce_hub_custom_css .='padding-top: '.esc_html($ecommerce_hub_product_top).'px; padding-bottom: '.esc_html($ecommerce_hub_product_bottom).'px; padding-left: '.esc_html($ecommerce_hub_product_left).'px; padding-right: '.esc_html($ecommerce_hub_product_right).'px;';
		$ecommerce_hub_custom_css .='}';
	}
	...
	if($ecommerce_hub_product_border_radius != false){
		$ecommerce_hub_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$ecommerce_hub_custom_css .='border-radius: '.esc_html($ecommerce_hub_product_border_radius).'px;';
		$ecommerce_hub_custom_css .='}';
	}
	...
	if($ecommerce_hub_product_sale_top != false || $ecommerce_hub_product_sale_bottom != false || $ecommerce_hub_product_sale_left != false || $ecommerce_hub_product_sale_right != false){
		$ecommerce_hub_custom_css .='.woocommerce span.onsale {';
			$ecommerce_hub_custom_css .='padding-top: '.esc_html($ecommerce_hub_product_sale_top).'px; padding-bottom: '.esc_html($ecommerce_hub_product_sale_bottom).'px; padding-left: '.esc_html($ecommerce_hub_product_sale_left).'px; padding-right: '.esc_html($ecommerce_hub_product_sale_right).'px;';
		$ecommerce_hub_custom_css .='}';
	}
	...
	if($ecommerce_hub_product_sale_border_radius != false){
		$ecommerce_hub_custom_css .='.woocommerce span.onsale {';
			$ecommerce_hub_custom_css .='border-radius: '.esc_html($ecommerce_hub_product_sale_border_radius).'px;';
		$ecommerce_hub_custom_css .='}';
	}
	...
	if($ecommerce_hub_slider_overlay_color != false){
		$ecommerce_hub_custom_css .='#slider  {';
			$ecommerce_hub_custom_css .='background-color: '.esc_html($ecommerce_hub_slider_overlay_color).';';
		$ecommerce_hub_custom_css .='}';
	}
	...
	$ecommerce_hub_custom_css .='#comments textarea{';
		$ecommerce_hub_custom_css .=' width:'.esc_html($ecommerce_hub_comment_width).'%;';
	$ecommerce_hub_custom_css .='}';
	...
	if($ecommerce_hub_footer_bg_color != false){
		$ecommerce_hub_custom_css .='#footer{';
			$ecommerce_hub_custom_css .='background-color: '.esc_html($ecommerce_hub_footer_bg_color).';';
		$ecommerce_hub_custom_css .='}';
	}
	...
	if($ecommerce_hub_footer_bg_image != false){
		$ecommerce_hub_custom_css .='#footer{';
			$ecommerce_hub_custom_css .='background: url('.esc_html($ecommerce_hub_footer_bg_image).');';
		$ecommerce_hub_custom_css .='}';
	}
	...
	if($ecommerce_hub_feature_image_border_radius != false){
		$ecommerce_hub_custom_css .='.blog-sec img{';
			$ecommerce_hub_custom_css .='border-radius: '.esc_html($ecommerce_hub_feature_image_border_radius).'px;';
		$ecommerce_hub_custom_css .='}';
	}
	...
	if($ecommerce_hub_feature_image_shadow != false){
		$ecommerce_hub_custom_css .='.blog-sec img{';
			$ecommerce_hub_custom_css .='box-shadow: '.esc_html($ecommerce_hub_feature_image_shadow).'px '.esc_html($ecommerce_hub_feature_image_shadow).'px '.esc_html($ecommerce_hub_feature_image_shadow).'px #aaa;';
		$ecommerce_hub_custom_css .='}';
	}
	...
	$ecommerce_hub_custom_css .=' .fixed-header{';
		$ecommerce_hub_custom_css .=' padding-top: '.esc_html($ecommerce_hub_top_sticky_header_padding).'px; padding-bottom: '.esc_html($ecommerce_hub_bottom_sticky_header_padding).'px';
	$ecommerce_hub_custom_css .='}';
	...
	if($ecommerce_hub_menu_font_size != false){
		$ecommerce_hub_custom_css .='.nav-menu li a{';
			$ecommerce_hub_custom_css .='font-size: '.esc_html($ecommerce_hub_menu_font_size).'px;';
		$ecommerce_hub_custom_css .='}';
	}
	...
	$ecommerce_hub_custom_css .='.social-media i{';
		$ecommerce_hub_custom_css .='font-size: '.esc_html($ecommerce_hub_social_icons_font_size).'px;';
	$ecommerce_hub_custom_css .='}';
